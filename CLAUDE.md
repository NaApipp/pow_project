# CLAUDE.md — POW (Point of Sale + Warehouse)

Context file ini digunakan oleh AI coding assistant (Claude Code) agar memahami arsitektur, konvensi, dan batasan project sebelum melakukan perubahan kode. Selalu baca file ini terlebih dahulu sebelum membuat fitur baru.
